...
Follow these steps to run Chef's AI Studio locally:

### 1. Clone the Repository
```bash
git clone https://github.com/veena694/Chef-s-AI-Studio.git
cd Chef-s-AI-Studio
```
...
REACT_APP_CLAUDE_KEY=your_anthropic_api_key (optional)
```

### 4. Run the Development Server
```bash
npm run dev
# or if using default react-scripts
npm start
```
...
This project follows a strict custom design system built with CSS variables to support responsive glassmorphism layouts down to `320px` width. Standard components are kept modular, robust, and clean, with a highly immersive light/dark kitchen theme override.
